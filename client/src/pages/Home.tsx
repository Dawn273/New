...
const features = [
  {
    ...
    description: "Strategic guidance and training for professional growth and organizational success.",
    icon: () => (
  ...
  },
  {
    ...
    description: "Professional guidance in EEO investigations and legal practice management.",
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-primary">
  ...
  {
    title: "Empowerment Speaking",
    description: "Inspiring presentations and workshops for professional development and growth.",
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-primary">
